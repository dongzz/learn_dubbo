...
public enum Type {
    ...
    ENEMY1(2,2,"敌军", "images/tank/enemy1%s.gif", 7, 1),
    ...
    BULLET(3,1,"友军子弹", "images/bullet/bullet%s.gif", 8, 1),
    ENEMYBULLET(3,2, "敌军子弹", "images/bullet/bullet%s.gif", 8, 1);
    ...
    public static List<Type> getEnemyTank() {
        return Arrays.stream(Type.values()).filter(e -> e.getCode() == 2).collect(Collectors.toList());
    }
    ...
    public static List<Type> getEnemyUnit() {
